...
deparse around where the program is currently stopped.
"""
    ...
    def run(self, args):
        ...
        try:
            ...
            self.errmsg("trepan_deparse needs to be installed to run this command")
            return
        ...
        try:
            walk = deparse.uncompyle_find(sys_version, co, last_i)
        except:
