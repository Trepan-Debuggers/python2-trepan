...
def format_code(code_object, style):
    """
...
def format_frame(frame_object, style):
    """
...
def print_location(proc_obj):
    ...
    def prefix_for_filename(deparsed_text):
        """
    ...
    while i_stack >= 0:
        ...
        if "<string>" == filename and dbgr_obj.eval_string:
            ...
            if deparsed:
                ...
                leading_code_str = prefix_for_filename(deparsed)
